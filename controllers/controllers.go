...
func Signup() gin.HandlerFunc{
	...
	return func(c *gin.Context){
		...
		//insert in user collection database
...
func Login() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		//if password is valid generate token for user
...
func SearchProductByQuery() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		//check if query if empty or not
		if queryParam == ""{
		...
		// if query has name, find it in database and capture it in a variable  (Find() → gives cursor) Cursor: A pointer to results, not actual data yet
		...
		//Read all data from cursor and convert into Go structs; All() → converts cursor → slice
